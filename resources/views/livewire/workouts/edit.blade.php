<div class="max-w-md mx-auto mt-10 p-6 bg-white rounded shadow">
    <h2 class="text-2xl font-bold mb-4">Edit Workout</h2>
    <form wire:submit.prevent="updateWorkout">
        ...
        <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded">Update Workout</button>
